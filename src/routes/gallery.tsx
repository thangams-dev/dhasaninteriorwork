...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "interior project gallery, modular kitchen gallery, wardrobe designs, TV unit designs, pooja unit gallery, home interior photos, before after interiors, completed projects, interior inspiration, modular kitchen portfolio, kitchen design gallery, wardrobe gallery Coimbatore, wardrobe gallery Tenkasi, TV unit gallery, pooja unit gallery, bedroom interior gallery, office interior gallery, kitchen before after, interior design portfolio, interior projects Coimbatore, interior projects Tenkasi, home makeover gallery, kitchen renovation gallery, home interior transformation, interior design showcase, completed kitchen projects, completed wardrobe projects, award-winning projects, luxury kitchen gallery, budget kitchen gallery, PVC kitchen gallery, modular kitchen designs, kitchen layouts, wardrobe solutions, TV unit styles, pooja room designs, bedroom design ideas, office design inspiration, interior design trends, modern kitchen gallery, contemporary interior gallery, traditional interior gallery, minimalist kitchen design, small space kitchen, large kitchen design, kitchen island design, open kitchen design, closed kitchen design" },
