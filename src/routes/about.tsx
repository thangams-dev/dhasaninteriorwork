...
import interiorBanner from "@/assets/interior-banner.png";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.dhasankitchenandinteriors.in/about" },
      { property: "og:site_name", content: "Dhasan Kitchen & Interior Work" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://www.dhasankitchenandinteriors.in/about" }],
  }),
  component: About,
});
    ...
    <>
      <section className="relative py-24 px-6 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img src={interiorBanner} alt="" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <div className="relative">
              ...
              <img src={poojaPartition} alt="Decorative gold leaf partition with tree of life and Kamadhenu cow motif by Dhasan" className="relative rounded-3xl border border-gold/30 w-full aspect-[3/4] object-cover" />
            </div>
          </Reveal>
          <Reveal delay={150}>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto relative rounded-3xl overflow-hidden border-gold-glow">
          <img src={wardrobe} alt="Custom walnut wardrobe with dressing mirror by Dhasan Interior" className="absolute inset-0 w-full h-full object-cover opacity-30" />
