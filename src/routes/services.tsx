...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "modular kitchen services, PVC kitchen design, wardrobe design, TV unit installation, pooja unit design, home interior services, bedroom interiors, office interiors, kitchen renovation services, interior design services Tenkasi, custom furniture, modular kitchen Coimbatore, modular kitchen Tenkasi, kitchen design Coimbatore, kitchen design Tenkasi, interior design Coimbatore, interior design Tenkasi, PVC kitchen Coimbatore, PVC kitchen Tenkasi, wardrobe design Coimbatore, wardrobe design Tenkasi, TV unit design Coimbatore, TV unit design Tenkasi, pooja unit Coimbatore, pooja unit Tenkasi, bedroom interior Coimbatore, bedroom interior Tenkasi, office interior Coimbatore, office interior Tenkasi, kitchen renovation Coimbatore, kitchen renovation Tenkasi, false ceiling design, wall partition design, interior decoration, kitchen cabinet design, custom kitchen design, modular wardrobe, sliding wardrobe, hinged wardrobe, bedroom interior design, office interior design, workspace design, workstation design, reception design, kitchen remodeling, home renovation, full home interiors, interior design package, complete kitchen solution, modern kitchen design, contemporary interior design, luxury kitchen design, budget-friendly kitchen, affordable kitchen design, premium kitchen design, kitchen with island, L-shaped kitchen, U-shaped kitchen, parallel kitchen, galley kitchen, open kitchen design, closed kitchen design, kitchen with breakfast counter, kitchen with dining area, kitchen storage solutions, wardrobe storage solutions, kitchen lighting design, bedroom lighting design, office lighting design, interior design consultation, kitchen design consultation, free site visit, on-site measurement" },
